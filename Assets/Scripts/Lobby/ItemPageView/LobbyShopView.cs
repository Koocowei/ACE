...
public class LobbyShopView : MonoBehaviour
{
    ...
    public void InitShop()
    {
        ...
        CreateShopItem(All_ShopItem_Sample[0], All_ShopItem_Sample[0].transform.parent.gameObject, DataManager.Stamina_Shop, AlbumEnum.Shop_Stamina);
        CreateShopItem(All_ShopItem_Sample[1], All_ShopItem_Sample[1].transform.parent.gameObject, DataManager.Gold_Shop, AlbumEnum.Shop_Gold);
        CreateShopItem(All_ShopItem_Sample[2], All_ShopItem_Sample[2].transform.parent.gameObject, DataManager.ExtraTime_Shop, AlbumEnum.Shop_ExtraTime);

        CreateShopItem(Stamina_Sample, Stamina_Parent, DataManager.Stamina_Shop, AlbumEnum.Shop_Stamina);
        CreateShopItem(Gold_Sample,Gold_Parent,DataManager.Gold_Shop, AlbumEnum.Shop_Gold);
        CreateShopItem(ExtraTime_Sample,ExtraTime_Parent,DataManager.ExtraTime_Shop, AlbumEnum.Shop_ExtraTime);
    }
    #endregion
